package km.project.LocalMetaWeather

import android.app.Activity
import km.project.LocalMetaWeather.api.retrofit.APILocationSearchWeather
import km.project.LocalMetaWeather.api.retrofit.php.APILocationSearchService
import km.project.LocalMetaWeather.model.LocationModel
import km.project.LocalMetaWeather.model.WeatherDataModel
import km.project.LocalMetaWeather.model.WeatherInfoModel
import km.project.LocalMetaWeather.util.AlertUtil
...
class WeatherSearch {
    ...
    private fun requestSearchWeather(retrofit: Retrofit, location: LocationModel) {
        val service = retrofit.create(APILocationSearchWeather::class.java)
